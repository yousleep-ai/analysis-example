...
```
ghcr.io/yousleep-ai/yousleep/example-downstream-analysis:VERSION
ghcr.io/yousleep-ai/yousleep/example-downstream-analysis:latest
```

**Example**: `example-downstream-analysis:1.0.0`
...
docker buildx build \
  ...
  -t ghcr.io/yousleep-ai/yousleep/example-downstream-analysis:${VERSION} \
  -t ghcr.io/yousleep-ai/yousleep/example-downstream-analysis:latest \
  --push \
  .
```
...
docker buildx build \
  ...
  -t example-downstream-analysis:test \
  --load \
  .
